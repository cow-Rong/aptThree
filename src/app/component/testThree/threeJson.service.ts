export const DATA = [
    ...
    { type: 'fire', size: [1.5, 1.5, 1.5], position: [-9, 0.75, -12], bgcolor: 0xfac146, text: '防火墙' },
    { type: 'switchesSmall', size: [2, 0.5, 2], position: [0, 0.25, -7.5], bgcolor: 0x2c55d6, text: '交换机' },     // (web)交换机
    { type: 'switchesSmall', size: [2, 0.5, 2], position: [-6, 0.25, 9.5], bgcolor: 0x2c55d6, text: '交换机' },       // 业务域交换机
    { type: 'switchesSmall', size: [2, 0.5, 2], position: [6, 0.25, 9.5], bgcolor: 0x2c55d6, text: '交换机' },   // 管理域交换机
    { type: 'host', size: [1.5, 1.5, 1.5], position: [9.25, 0.75, 12.75], bgcolor: 0x2c55d6, text: '管理终端' },
    { type: 'host', size: [1.5, 1.5, 1.5], position: [6, 0.75, 12.75], bgcolor: 0x2c55d6, text: '管理终端' },
    { type: 'host', size: [1.5, 1.5, 1.5], position: [2.75, 0.75, 12.75], bgcolor: 0x2c55d6, text: '管理终端' },
    { type: 'host', size: [1.5, 1.5, 1.5], position: [-8.25, 0.75, 12.75], bgcolor: 0x2c55d6, text: '业务系统' },     // 业务域
    { type: 'host', size: [1.5, 1.5, 1.5], position: [-3.75, 0.75, 12.75], bgcolor: 0x2c55d6, text: '业务系统' },
